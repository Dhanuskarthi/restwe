...
## OUTPUT:
![alt text](<myapp/static/Screenshot (47).png>)
![alt text](<myapp/static/Screenshot (48).png>)
![alt text](<myapp/static/Screenshot (49).png>)
![alt text](<myapp/static/Screenshot (50).png>)
## RESULT:
